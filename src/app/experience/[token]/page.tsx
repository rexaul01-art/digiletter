      ...
      <div className="w-full max-w-lg mx-auto flex flex-col items-center justify-center min-h-[500px]">
        ...
        {experiencePhase === "slider" && (
          <motion.div 
            ...
            animate={{ opacity: 1, scale: 1 }}
            className="w-full min-h-[340px] max-w-md bg-pastel-pink border-thick rounded-3xl p-6 shadow-offset relative flex flex-col justify-between items-center text-center overflow-hidden"
          >
